...
export const blogsData = [{
  ...
  id: '1003',
  title: 'Never underestimate the influence of VELTRIX IT SOLUTIONS PRIVATE LIMITED',
...
export const eventScheduleData = [{
  ...
  events: [{
    avatar: avatar1,
    title: 'Grad Opening',
    description: 'by Lori Stevens Chairman of VELTRIX IT SOLUTIONS PRIVATE LIMITED',
    ...
    description: 'by Larry Lawson Co-founder and Carolyn Ortiz VELTRIX IT SOLUTIONS PRIVATE LIMITED Director',
