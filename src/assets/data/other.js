...
export const blogsData = [{
  ...
  id: '1003',
  title: 'Never underestimate the influence of Swhizz',
...
export const eventScheduleData = [{
  ...
  events: [{
    avatar: avatar1,
    title: 'Grad Opening',
    description: 'by Lori Stevens Chairman of Swhizz',
    ...
    description: 'by Larry Lawson Co-founder and Carolyn Ortiz Swhizz Director',
