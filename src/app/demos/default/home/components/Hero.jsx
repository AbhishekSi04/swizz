        ...
        <Row className="align-items-center g-5">
          <Col lg={5} xl={6} className="position-relative z-index-1 text-center text-lg-start mb-7 mb-sm-0">
            ...
            <div className="mb-4">
              <span className="badge bg-light text-primary px-3 py-2 rounded-pill">
                <span className="text-primary fw-bold">Veltrix IT Solution Prvate Limited </span> | Your Partner in Digital Innovation
              </span>
            </div>
            <h1 className="mb-4 display-5 fw-bold text-dark-mode-white">
              Top-notch Software Training Institute in Hyderabad
            </h1>
            <p className="my-4 lead text-dark-mode-white">
            ...
            <ul className="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
              <li className="list-inline-item me-3 icons-center">
                <BsPatchCheckFill className="me-2 text-primary" />
                <span className="text-dark-mode-white">Expert Solutions</span>
              </li>
              <li className="list-inline-item me-3 icons-center">
                <BsPatchCheckFill className="me-2 text-primary" />
                <span className="text-dark-mode-white">24/7 Support</span>
              </li>
              <li className="list-inline-item icons-center">
                <BsPatchCheckFill className="me-2 text-primary" />
                <span className="text-dark-mode-white">Proven Results</span>
              </li>
            </ul>
            <div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
              <a href="#" className="btn btn-lg btn-primary me-3 mb-4 mb-sm-0 px-4">
                Get Started
              </a>
              <a href="#" className="btn btn-lg btn-outline-primary mb-4 mb-sm-0 px-4">
                Learn More
              </a>
            </div>
          </Col>
          <Col lg={7} xl={6} className="text-center position-relative">
            ...
            <div className="position-relative ms-sm-4">
              <img src='https://themes.stackbros.in/eduport_r/assets/07-CK3ZrEuH.png' alt="element-image" />
            </div>
          </Col>
        </Row>
      </Container>
