              ...
              <Col md={7} className="position-relative mb-0 mt-0 mt-md-5">
                ...
                <div className="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                  ...
                  <ul className="list-inline mb-2">
                    ...
                    {4.5 < 5 &&
                      Array(5 - Math.ceil(4.5)).fill(0).map((_star, idx) => (
                        <li key={idx} className="list-inline-item me-1 small">
                          <FaRegStar size={14} className="text-warning" />
                        </li>
                      ))}
                  </ul>
                  <h6 className="mb-0">Rahul Verma</h6>
                </div>
              </Col>
                ...
                <div className="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                  ...
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <div className="ms-2">
                      ...
                      <p className="mb-0 small">Trainer - Java</p>
                    </div>
                  </div>
                  <div className="d-flex align-items-center mb-3">
                    <div className="avatar avatar-sm">
                    ...
                    <div className="ms-2">
                      ...
                      <p className="mb-0 small">Trainer - DevOps</p>
                    </div>
                  </div>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      ...
                      <p className="mb-0 small">Trainer - Salesforce</p>
                    </div>
                  </div>
                </div>
              </Col>
            ...
            <Row className="mt-5 mt-xl-0">
              <Col xs={7} className="mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                ...
                >
                  ...
                  <p className="text-white mb-0">Based on 1,200+ reviews</p>
                </div>
              </Col>
                ...
                <div className="bg-body shadow text-center p-4 rounded-3">
                  ...
                  <blockquote>
                    <p>
                      ...
                      I enrolled for Salesforce Admin. The curriculum is industry-focused and the placement team continuously shared openings.
                      I landed an admin role in Hyderabad within a month of course completion.
                      <span className="ms-1 small">
                        <FaQuoteRight />
                      </span>
                    </p>
                  ...
                  <h6 className="mb-0">Shruti Nair</h6>
                </div>
              </Col>
            </Row>
          </Col>
