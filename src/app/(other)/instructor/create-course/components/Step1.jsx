  ...
  return <form id="step-1" onSubmit={goToNextStep} role="tabpanel" className="content fade" aria-labelledby="steppertrigger1">
      ...
      <Row className="g-4">
        <Col xs={12}>
          ...
          <input className="form-control" type="text" placeholder="Enter course title" value={courseData.title} onChange={e => updateCourse({ title: e.target.value })} />
        </Col>
        <Col xs={12}>
          <label className="form-label">Short description</label>
          <textarea className="form-control" rows={2} placeholder="Short description" value={courseData.description} onChange={e => updateCourse({ description: e.target.value })} />
        </Col>
        <Col md={6}>
        ...
        <Col md={6}>
          ...
          <input type="number" className="form-control" placeholder="Enter course price" value={courseData.price} onChange={e => updateCourse({ price: Number(e.target.value || 0) })} />
        </Col>
        <Col md={6}>
