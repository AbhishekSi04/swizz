        ...
        <Row className="g-4">
          <Col lg={3}>
            <Link className="me-0" to="/">
              <img className="light-mode-item h-40px" width={189} height={40} src={logo} alt="Swhizz logo" />
              <img className="dark-mode-item h-40px" width={189} height={40} src={logoLight} alt="Swhizz logo" />
            </Link>
            <p className="my-3">
