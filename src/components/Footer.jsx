        ...
        <Row className="g-4">
          <Col lg={3}>
            <Link className="me-0" to="/">
              <img className="light-mode-item h-40px" width={189} height={40} src="/assets/images/VeltrixLogoLight.png" alt="VELTRIX IT SOLUTIONS" />
              <img className="dark-mode-item h-40px" width={189} height={40} src="/assets/images/VeltrixLogo.png" alt="VELTRIX IT SOLUTIONS" />
            </Link>
          ...
          <Container className="px-0">
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
              <div className="text-body text-primary-hover">
                ...
                Copyrights ©{currentYear} VELTRIX IT SOLUTIONS PRIVATE LIMITED. Build by
